...
namespace YNL.Extension.Method
{
    public static class MTween
    {
        ...
        /// </summary>
        public static Coroutine TweenFillAmount(this MonoBehaviour mono, Image image, float targetFillAmount, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.FillAmountTweenCoroutine(image, image.fillAmount, targetFillAmount, duration, tween));
        ...
        public static Coroutine TweenColor(this MonoBehaviour mono, Image image, Color target, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartACoroutine(MTweenCoroutine.ColorCoroutine(image, image.color, target, duration, tween));
        public static Coroutine TweenColor(this MonoBehaviour mono, Image image, Color start, Color target, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartACoroutine(MTweenCoroutine.ColorCoroutine(image, start, target, duration, tween));
        ...
        public static Coroutine TweenColor(this MonoBehaviour mono, TextMeshProUGUI tmp, Color color2, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.ColorCoroutine(tmp, color2, duration, tween));
        ...
        public static Coroutine TweenRectTransform(this MonoBehaviour mono, RectTransform rectTransform, RectTransform target, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.RectTransformCoroutine(rectTransform, target, duration, tween));
        ...
        public static Coroutine TweenAnchoredPosition(this MonoBehaviour mono, RectTransform rectTransform, Vector2 targetPosition, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.AnchoredPositionCoroutine(rectTransform, targetPosition, duration, tween));
        ...
        public static Coroutine TweenRotation(this MonoBehaviour mono, RectTransform rectTransform, Vector3 target, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.RotationCoroutine(rectTransform, target, duration, tween));
        ...
        public static Coroutine TweenScale(this MonoBehaviour mono, RectTransform rectTransform, Vector3 target, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.ScaleCoroutine(rectTransform, target, duration, tween));
        ...
        public static Coroutine TweenSize(this MonoBehaviour mono, RectTransform rectTransform, Vector2 target, float duration, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.SizeCoroutine(rectTransform, target, duration, tween));
        ...
        public static Coroutine TweenMaterial(this MonoBehaviour mono, Material material, string key, float target, float duration, Action onComplete = null, TweenType tween = TweenType.ExponentialInterpolation)
            => mono.StartCoroutine(MTweenCoroutine.MaterialCoroutine(material, key, target, duration, onComplete, tween));
    }

    public static class MTweenCoroutine
    {
        public static IEnumerator FillAmountTweenCoroutine(Image image, float startFillAmount, float targetFillAmount, float duration, TweenType tween)
        {
            ...
            while (elapsedTime < duration)
            {
                ...
                if (tween == TweenType.ExponentialInterpolation) image.fillAmount = Mathf.Lerp(image.fillAmount, targetFillAmount, normalizedTime);
                if (tween == TweenType.LinearInterpolation) image.fillAmount = Mathf.Lerp(startFillAmount, targetFillAmount, normalizedTime);
                yield return null;
            }
        ...
        public static IEnumerator ColorCoroutine(Image image, Color start, Color target, float duration, TweenType tween)
        {
            float elapsedTime = 0f;
            image.color = start;
